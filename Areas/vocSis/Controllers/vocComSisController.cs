...
{
    public class vocComSisController : ListController
    {
        //
        // GET: /vocSis/vosComSis/
 

        public ActionResult cSList(int? navId, RequestData data)
        {
        ...
        private DataTable NewMethod(RequestData data)
        {
            ...
            var table = MonitorData.GetMonitorData("", DateTime.Parse(Request.QueryString["startTime1"]), DateTime.Parse(Request.QueryString["endTime1"]), "C", Request.QueryString["Companyid"], Request.QueryString["selectData"], "VOCsItem");
