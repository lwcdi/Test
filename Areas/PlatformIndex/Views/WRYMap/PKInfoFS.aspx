    ...
    <script>
        ...
        function LoadPKInfoDataTable() {
            ...
            var trHtml = pkInfoTableRow.replace("NAME", pkMonitorData.NAME).replace("DATA_TIME", pkMonitorData.DATA_TIME)
                    .replace("flow_water_Value", pkMonitorData.flowwater_Value);
            $("#PKInfoDataTable tbody").append(trHtml);

            var trPFHtml = pfInfoTableRow.replace("w01018_ND_Value", pkMonitorData.w01018_ND_Value).replace("w21003_ND_Value", pkMonitorData.w21003_ND_Value)
                            .replace("w01018_PFL_Value", pkMonitorData.w01018_PFL_Value).replace("w21003_PFL_Value", pkMonitorData.w21003_PFL_Value);
        ...
        var pkInfoTableRow =
            ...
            "<td style='border: 1px solid #D4D4D4;width:100px;height:25px;'>流量（立方米）</td><td style='border: 1px solid #D4D4D4;width:60px;height:25px;'>flow_water_Value</td>" +
            "</tr>" +
            "<tr>";
            //+
            //"<td style='border: 1px solid #D4D4D4;width:100px;height:25px;'>流量（立方米）</td><td rowspan='5' style='border: 1px solid #D4D4D4;width:175px;height:25px;'>flow_water_Value</td>" +
        ...
        var pfInfoTableRow =
           ...
           "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>化学需氧量</td>" +
           "<td style='border: 1px solid #D4D4D4;width:153px;height:25px;'>氨氮</td>" +
           "</tr>" +
           "<tr>" +
           "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>浓度（毫克/升）：</td>" +
           "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>w01018_ND_Value</td>" +
           "<td style='border: 1px solid #D4D4D4;width:153px;height:25px;'>w21003_ND_Value</td>" +
           "</tr>" +
           "<tr>" +
            "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>排放量（千克）：</td>" +
            "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>w01018_PFL_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:153px;height:25px;'>w21003_PFL_Value</td>" +
            "</tr>";
    </script>
</asp:Content>
