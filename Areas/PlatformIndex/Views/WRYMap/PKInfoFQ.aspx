...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script>
        ...
        function LoadPKInfoDataTable() {
            ...
            var trHtml = pkInfoTableRow.replace("NAME", pkMonitorData.NAME).replace("DATA_TIME", pkMonitorData.DATA_TIME).replace("flow_gas_Value", pkMonitorData.flowgas_Value)
                                       .replace("a19001_Value", pkMonitorData.a19001_Value).replace("a01012_Value", pkMonitorData.a01012_Value).replace("a01013_Value", pkMonitorData.a01013_Value);
            $("#PKInfoDataTable tbody").append(trHtml);

            var trPFHtml = pfInfoTableRow.replace("a34013_ND_Value", pkMonitorData.a34013_ND_Value).replace("a21026_ND_Value", pkMonitorData.a21026_ND_Value).replace("a21002_ND_Value", pkMonitorData.a21002_ND_Value)
                            .replace("a34013_ZSND_Value", pkMonitorData.a34013_ZSND_Value).replace("a21026_ZSND_Value", pkMonitorData.a21026_ZSND_Value).replace("a21002_ZSND_Value", pkMonitorData.a21002_ZSND_Value)
                            .replace("a34013_PFL_Value", pkMonitorData.a34013_PFL_Value).replace("a21026_PFL_Value", pkMonitorData.a21026_PFL_Value).replace("a21002_PFL_Value", pkMonitorData.a21002_PFL_Value);
        ...
        var pkInfoTableRow =
            ...
            "<td style='border: 1px solid #D4D4D4;width:100px;height:25px;'>流量（立方米）</td><td style='border: 1px solid #D4D4D4;width:60px;height:25px;'>flow_gas_Value</td>" +
            "</tr>" +
            "<tr>" +
            //+
            //"<td style='border: 1px solid #D4D4D4;width:100px;height:25px;'>流量（立方米）</td><td rowspan='5' style='border: 1px solid #D4D4D4;width:175px;height:25px;'>flow_gas_Value</td>" +
            ...
            //"</tr>";
            "<tr>" +
            "<td style='border: 1px solid #D4D4D4;width:70px;height:25px;'>含氧量（百分比）</td><td style='border: 1px solid #D4D4D4;width:120px;height:25px;'>a19001_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:70px;height:25px;'>烟气温度（摄氏度）</td><td style='border: 1px solid #D4D4D4;width:130px;height:25px;'>a01012_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:100px;height:25px;'>烟气压力（帕）</td><td style='border: 1px solid #D4D4D4;width:60px;height:25px;'>a01013_Value</td>" +
            "</tr>" +
            "<tr>";

        var pfInfoTableRow =
           "<tr>" +
           "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>污染物因子</td>" +
           "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>烟尘</td>" +
           "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>二氧化硫</td>" +
           "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>氮氧化物</td>" +
           "</tr>" +
           "<tr>" +
           "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>浓度（毫克/立方米）</td>" +
           "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a34013_ND_Value</td>" +
           "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a21026_ND_Value</td>" +
           "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a21002_ND_Value</td>" +
           "</tr>" +
           "<tr>" +
            "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>折算浓度（毫克/立方米）</td>" +
            "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a34013_ZSND_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a21026_ZSND_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a21002_ZSND_Value</td>" +
            "</tr>" +
            "<tr>" +
            "<td style='border: 1px solid #D4D4D4;width:200px;height:25px;'>排放量（千克）</td>" +
            "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a34013_PFL_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a21026_PFL_Value</td>" +
            "<td style='border: 1px solid #D4D4D4;width:117px;height:25px;'>a21002_PFL_Value</td>" +
            "</tr>";
    </script>
</asp:Content>
