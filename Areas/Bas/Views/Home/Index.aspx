...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/content/css/font.css" />
...
<body class="easyui-layout" style="overflow-y: hidden;" fit="true" scroll="no">
    ...
    <script type="text/javascript" src="/Content/js/FileUpload.js"></script>
      <script type="text/javascript" src="/Content/js/ListMoban.js"></script>
    <script type="text/javascript" src="/Scripts/echarts.js"></script>
    <script type="text/javascript" src="/Content/js/page.js"></script>
     <script type="text/javascript" src="/Content/js/ListMoban.js?v=1001"></script>
    <script type="text/javascript">
        $(function () {
            idx.init();
        });
    </script>
    <%--<script type="text/javascript" src="/content/js/icon.js"></script>--%>
</body>
</html>
