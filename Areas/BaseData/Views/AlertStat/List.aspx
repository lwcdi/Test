...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script>
        ...
        function getData() {
            $("#dg").datagrid({
                url: "/BaseData/AlertStat/GetAlert",
                queryParams: {
                    pkid: pkid,
                    companyid: companyid,
                ...
                columns: [[
                    ...
                    { title: "污染物超标", field: "TYPE0", width: 100, align: "right" },
                    { title: "污染物异常", field: "TYPE1", width: 100, align: "right" },
                    { title: "排放量异常", field: "TYPE2", width: 100, align: "right" },
                    { title: "数采仪掉线", field: "TYPE3", width: 100, align: "right" },
                    { title: "未处理次数", field: "STATE0", width: 100, align: "right" },
                    {
                        title: "总次数", field: "STATE1", width: 100, align: "right", formatter: function (value, row, index) {
                            return row.STATE0 + row.STATE1;
                        }
                    }
                ]]
            });
