...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="padding: 2px; overflow: hidden;">
            <table class="grid">
                ...
                <tr>
                    <td>启用日期：</td>
                    <td><input id="STARTTIME" name="STARTTIME" type="text" class="txt03 easyui-validatebox" data-options="required:true" style="width: 200px" /></td>
                </tr>
                <tr>
                    <td>传输类型：</td>
                    <td><input id="TrueName" name="TrueName" type="text" class="txt03 easyui-validatebox" data-options="required:true" style="width: 200px" /></td>
                </tr>
                <tr>
                    <td>SIM（UIM）卡号：</td>
                    <td>
