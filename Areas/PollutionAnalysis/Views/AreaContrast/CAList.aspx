...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetChart(s1, s2, s3, s4) {
            ...
            $.ajax({
                type: "post",
                url: "/PollutionAnalysis/AreaContrast/getChartInfo?" + param,
        ...
        function getData(s1, s2, s3, s4) {
            ...
            $("#dg").datagrid({
                url: "/PollutionAnalysis/AreaContrast/getDataInfo?" + param,
                idField: "CODE",
                pagination: true,
                pageSize: 100,
                singleSelect: true,
                ...
                columns: [[
                      ...
                      { title: "区域", field: "AREA_NAME", width: 150 },
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
       ...
       <div id="layout">
        ...
        <div region="west" split="true" style="width: 200px; padding: 5px">
        ...
        <div region="center" title="区域对比" iconcls="icon-edit">
            <!--顶部工具栏-->
            <div id="toolbar">
                <%--<form id="qform">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="timeRang" id="yearDiv">
                                    <select id="stimeRangOnlyYear" name="stimeRangOnlyYear" class="txt03 inputSize"></select>至
                                      <select id="etimeRangOnlyYear" name="etimeRangOnlyYear" class="txt03 inputSize"></select>
                                </div>
