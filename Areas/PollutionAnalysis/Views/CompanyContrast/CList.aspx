...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetChart(s1, s2, s3, s4) {
            ...
            $.ajax({
                type: "post",
                url: "/PollutionAnalysis/CompanyContrast/getChartInfo?" + param,
        ...
        function getData(s1, s2, s3, s4) {
            ...
            $("#dg").datagrid({
                url: "/PollutionAnalysis/CompanyContrast/getDataInfo?" + param,
                idField: "CODE",
                pagination: true,
                pageSize: 100,
                singleSelect: true,
                ...
                columns: [[
                    { title: "监测时间", field: "DATA_TIME", width: 150 },
                      { title: "企业名字", field: "AREA_CODE", width: 150 },
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
      ...
      <div id="layout">
        ...
        <div region="center" title="企业对比" iconcls="icon-edit">
            <!--顶部工具栏-->
            <div id="toolbar">
                <%--<form id="qform">
