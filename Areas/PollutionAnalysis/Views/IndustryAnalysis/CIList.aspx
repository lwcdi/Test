   ...
   <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function GetChart(s1, s2, s3, s4) {
            ...
            $.ajax({
                type: "post",
                url: "/PollutionAnalysis/IndustryAnalysis/getChartInfo?" + param,
        ...
        var fieldInit = function () {
            ...
            $('#tt').tree({
                ...
                url: "/Bas/Common/GetIndustryData",
        ...
        function getData( s1,s2,s3,s4) {
            ...
            $("#dg").datagrid({
                url: "/PollutionAnalysis/IndustryAnalysis/getDataInfo?" + param,
                idField: "CODE",
                pagination: true,
                pageSize: 100,
                singleSelect: true,
                ...
                columns: [[
                    ...
                    { title: "行业", field: "AREA_NAME", width: 150 },
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <div id="layout">
        ...
        <div region="center" title="行业分析" iconcls="icon-edit">
            <!--顶部工具栏-->
            <div id="toolbar">
                <%--<form id="qform">
