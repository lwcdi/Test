...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function GetChart(s1, s2, s3, s4) {
            ...
            $.ajax({
                type: "post",
                url: "/PollutionAnalysis/IndustryContrast/getChartInfo?" + param,
        ...
        function getData( s1,s2,s3,s4) {
            ...
            $("#dg").datagrid({
                url: "/PollutionAnalysis/IndustryContrast/getDataInfo?" + param,
                idField: "CODE",
                pagination: true,
                pageSize: 100,
                singleSelect: true,
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <div id="layout">
        ...
        <div region="center" title="行业对比" iconcls="icon-edit">
            <!--顶部工具栏-->
            <div id="toolbar">
                <%--<form id="qform">
