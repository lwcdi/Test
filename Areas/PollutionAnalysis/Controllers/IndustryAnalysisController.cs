...
{
    public class IndustryAnalysisController : ListController
    {
        //
        // GET: /PollutionAnalysis/IndustryAnalysis/

        public ActionResult CIList(int? navId)
        {
            return View(navId ?? 0);
        }
        ...
        public string getDataInfo(RequestData data)
        {
            ...
            var list = IndustryData.GetAreaMonitorData(Request.QueryString["Companyid"], DateTime.Parse(Request.QueryString["startTime"]), DateTime.Parse(Request.QueryString["endTime"]), Request.QueryString["selectData"], "GasItem,WaterItem");
