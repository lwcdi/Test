...
{
    public class AreaAnalysisController : ListController
    {
     

        //
        // GET: /PollutionAnalysis/AreaAnalysis/



        public ActionResult AreaAnalysisList(int? navId)
        {
            return View(navId ?? 0);
        }
        ...
        public string getDataInfo(RequestData data)
        {
            ...
            var list = AnalysisData.GetAreaMonitorData(Request.QueryString["Companyid"], DateTime.Parse(Request.QueryString["startTime"]), DateTime.Parse(Request.QueryString["endTime"]), Request.QueryString["selectData"], "GasItem,WaterItem");
