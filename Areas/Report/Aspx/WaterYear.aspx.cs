...
{
    public partial class WaterYear : BaseReport
    {
        protected override void BandingReport()
        {
            ...
            DataTable table = MonitorData.GetMonitorDataForReportWater(Request.QueryString["dataFrom"], startTime, endTime, Request.QueryString["type"], Request.QueryString["id"], "month");
        ...
        private Dictionary<string, string> RdlcParam()
        {
            ...
            paramDic.Add("Title", "废水排放连续监测月平均值年报表");
            paramDic.Add("CheckTime", string.Format("监测年份：{0}年", Request.QueryString["timeRangYear"]));
