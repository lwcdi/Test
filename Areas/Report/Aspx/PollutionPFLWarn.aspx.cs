...
{
    public partial class PollutionPFLWarn : BaseReport
    {
        protected override void BandingReport()
        {
            ...
            DataTable table = MonitorData.GetPK_PFL_Warn(SerializerHelper.Deserialize<List<string>>(Request.QueryString["pkID"]),startTime, endTime,MonitorData.POLLUTION_MONITOR_ITEM_TYPE, Request.QueryString["rdlcType"]);
