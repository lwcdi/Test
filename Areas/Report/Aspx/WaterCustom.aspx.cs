...
{
    public partial class WaterCustom : BaseReport
    {
        protected override void BandingReport()
        {
            ...
            DataTable table = MonitorData.GetMonitorDataForReportWater(Request.QueryString["dataFrom"], startTime, endTime, Request.QueryString["type"], Request.QueryString["id"], "hour");
