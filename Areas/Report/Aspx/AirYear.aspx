<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirYear.aspx.cs" Inherits="UI.Web.Areas.Report.Aspx.AirYear" %>
    ...
    <div>
             <div>
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="100%" SizeToReportContent="true" HyperlinkTarget="_self" CssClass="ReportViewer"  KeepSessionAlive="false">
                        <LocalReport EnableHyperlinks="True"></LocalReport>
                </rsweb:ReportViewer>
            </div>
    </div>
    </form>
