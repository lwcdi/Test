            ...
            $("#btnCreate").click(function () {
                ...
                if ("custom" == reportType) {
                    ...
                    if (timeRangStart && timeRangEnd) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/WaterCustom.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
                if ("day" == reportType) {
                    ...
                    if (timeRangDay) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/WaterDay.aspx?"+param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
                if ("month" == reportType) {
                    ...
                    if (timeRangMonth && timeRangYear) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/WaterMonth.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
                if ("year" == reportType) {
                    ...
                    if (timeRangMonth && timeRangYear) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/WaterYear.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
