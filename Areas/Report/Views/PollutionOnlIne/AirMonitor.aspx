    ...
    <script>
        ...
        var fieldInit = function () {
            ...
            $("#btnCreate").click(function () {
                ...
                param.addParam({ "rdlcType": reportType });
                if ("custom" == reportType) {
                    ...
                    if (timeRangStart && timeRangEnd) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/AirCustom.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
                if ("day" == reportType) {
                    ...
                    if (timeRangDay) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/AirDay.aspx?"+param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
                if ("month" == reportType) {
                    ...
                    if (timeRangMonth && timeRangYear) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/AirMonth.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
                if ("year" == reportType) {
                    ...
                    if (timeRangMonth && timeRangYear) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/AirYear.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
...
<div id="layout">
    ...
    <div region="center" title="废气报表" iconcls="icon-house">
        <!--顶部工具栏-->
        <div id="toolbar">
            <form id="qform">
