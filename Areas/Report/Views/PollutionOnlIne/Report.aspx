    ...
    <script>
        ...
        var fieldInit = function () {
            ...
            $("#btnCreate").click(function () {
                ...
                param.addParam({ "reportType": reportType });
                if ("custom" == reportType) {
                    ...
                    if (timeRangStart && timeRangEnd) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/PollutionReportingRate.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
...
<div id="layout">
    ...
    <div region="center" title="污染源数据传输率" iconcls="icon-house">
        <!--顶部工具栏-->
        <div id="toolbar">
            <form id="qform">
