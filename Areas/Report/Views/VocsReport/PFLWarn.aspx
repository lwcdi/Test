    ...
    <script>
        ...
        var fieldInit = function () {
            ...
            $("#btnCreate").click(function () {
                ...
                param.addParam({ "pkID": JSON.stringify(pkID) });
                ...
                if ("custom" == reportType) {
                    ...
                    if (timeRangStart && timeRangEnd) {
                        $("#iBtn").attr("src", "/Areas/Report/Aspx/PollutionPFLWarn.aspx?" + param.toUrlParam());
                    } else {
                        com.msg.alert("请选择时间");
                    }
                }
...
<div id="layout">
    ...
    <div region="center" title="污染源排量预警统计" iconcls="icon-house">
        <!--顶部工具栏-->
        <div id="toolbar">
            <form id="qform">
